...
export default function About () {
    return (
        <section>
            ...
            angängare romantiken. Han var en notorisk kvinnotjusare, ständigt i skuld och hade ett rykte som <i>"mad, bad and dangerous to know".</i>
            </p>
            ...
            inte länge utan en månad efter Adas födelse så separerade de och Byron stack till Frankrike och skulle aldrig träffa sin dotter igen.</p>
            ...
            <p>
            <i>"lessons in the morning in arithmetic, grammar, spelling, reading, music, each no more than a quarter of an hour long - after dinner, geography, drawing, French, music, reading, all performed with alacrity and docility." (Hollings C, Martin U, Rice A, s.9)</i>
            </p>
            <p>
            ...
            <p>
            <i>"I now read Mathematics every day &amp; am occupied in Trigonometry &amp; in preliminaries to Cubic &amp; Biquadratic Equations. So you see
            that matrimony has by no means lessened my taste for those pursuits, nor my determination to carry them on..." 
            (Hollings C, Martin U, Rice A, s.32)</i>
            </p>
            ...
            <p>
            <i>"Supposing that the fundamental relations of pitched sounds in the science of harmony and of musical composition were susceptible
            ...
            or extent." (Hollings C, Martin U, Rice A, s.82)</i>
            </p>
            ...
            <p>
            <i>“If you can’t give me poetry, can’t you give me poetical science?”</i>
            </p>
